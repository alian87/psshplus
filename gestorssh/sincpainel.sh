...
wget github.com/JeanRocha91x/psshplus-/main/gestorssh/sshplus.zip.001 > /dev/null 2>&1
wget github.com/JeanRocha91x/psshplus-/main/gestorssh/sshplus.zip.002 > /dev/null 2>&1
wget github.com/JeanRocha91x/psshplus-/main/gestorssh/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget github.com/JeanRocha91x/psshplus-/main/gestorssh/sincpainel.zip > /dev/null 2>&1
