...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/alian87/psshplus/main3/gestorssh/chuser > /dev/null 2>&1
wget https://raw.githubusercontent.com/alian87/psshplus/main3/gestorssh/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/alian87/psshplus/main3/gestorssh/checkuser.py > /dev/null 2>&1
