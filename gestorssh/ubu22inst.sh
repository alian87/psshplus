...
{
	cd /bin || exit
	wget https://raw.githubusercontent.com/alian87/psshplus/main3/gestorssh/userteste.sh > /dev/null 2>&1
	wget https://raw.githubusercontent.com/alian87/psshplus/main3/gestorssh/autobackup.sh > /dev/null 2>&1
